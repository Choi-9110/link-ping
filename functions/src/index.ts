 ...
 */
export const iapVerify = functions.https.onRequest(async (req, res) => {
  // CORS
 ...
 */
async function verifyApple(body: VerifyRequest): Promise<boolean> {
 ...
 */
async function verifyGoogle(body: VerifyRequest): Promise<boolean> {
